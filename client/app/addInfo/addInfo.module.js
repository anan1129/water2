...
(function () {
    ...
    angular.module('app.addInfo', ['app.addInfo.controller', 'app.addInfo.state', 'angularFileUpload', 'textAngular','app.addInfo.directive'])
        ...
        //     $provide.decorator('taOptions', ['taRegisterTool', 'taOptions','taSelection', function (taRegisterTool,taOptions,taSelection) {
        ...
        //             "<ul class='dropdown-menu' style='width:180px;height:200px;overflow:auto;'><li ng-repeat='o in options'><button class='btn btn-blue checked-dropdown' type='button' ng-click='action($event, o.css)'><i ng-if='o.active' class='fa fa-check'></i> {{o.name}}</button></li></ul>" +
        //             "</span>",
        //             action: function (event, size) {
        //                 //Ask if event is really an event.
        //                 if (!!event.stopPropagation) {
